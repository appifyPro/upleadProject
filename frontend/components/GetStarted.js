    ...
    <div className="w-screen">
      <div className="text-center m-auto pt-20">
        ...
        <p className="my-10 text-lg  max-sm:text-sm m-auto w-[65%] max-md:w-[80%] text-gray-600">
          Packed with high-quality ingredients in every box, these delightful recipes offer unbeatable value. Crunch the numbers, and you'll find that preparing these dishes with us is more cost-effective than doing it solo.
        </p>
      ...
      <div className="flex w-[80%] py-20 max-md:flex-col max-md:w-[50%] max-md:gap-5 m-auto gap-10  text-sm text-gray-600 max-md:pt-10 ">
        <div className="flex gap-4">
          ...
          <p className="inline-block ">
            <span className="font-bold">Prospector</span> Build laser targeted lists of prospects.
          </p>
        </div>
        <div className="flex gap-4">
          <Image
          ...
          ></Image>
          <p className="inline-block">
            <span className="font-bold">Email Verification</span> Real time verification to ensure your leads are real
          </p>
        </div>
        <div className="flex gap-4">
          <Image
          ...
          ></Image>
          <p className="inline-block">
            <span className="font-bold">Data Enrichment </span>Enhance your current data with advanced data enrichment
          </p>
        </div>
      </div>
    </div>
