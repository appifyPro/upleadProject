    ...
    <div className="bg-[#00a0df]">
      ...
      <div className="text-white flex w-10/12 max-md:flex-col m-auto gap-10 mb-16 text-sm  max-md:w-[50%] ">
        ...
        <div className="text-center">
          ...
          <p>
            UpLead’s real-time email verification ensures you are always
        ...
        <div className="text-center">
          ...
          <p>
            Elevate your meals with premium, carefully selected ingredients.
            Experience the difference in taste and freshness.
          </p>
        </div>
      </div>
