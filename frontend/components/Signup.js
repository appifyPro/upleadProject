  ...
  return (
    <div className='flex w-10/12 m-auto justify-between max-md:flex-col max-md:text-center max-md:gap-7 items-center py-20'>
      <div>
        ...
        <p className='text-lg max-md:text-base font-semibold w-[70%] max-md:w-[90%] text-gray-600 mt-1'>Sign up to receive exclusive offers, mouthwatering recipes, latest news, and more delivered straight to your inbox.</p>
      </div>
